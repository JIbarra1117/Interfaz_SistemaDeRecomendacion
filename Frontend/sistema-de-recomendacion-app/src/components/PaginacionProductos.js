...
const PaginacionProductos = ({ productos }) => {
    ...
    return (
        <div className='max-w mx-auto p-4'>
            ...
            <div className='pe-10 pt-6'>
                <div class="flex rounded-lg items-center justify-between border-t border-gray-200 bg-white py-3 sm:px-11">
                    ...
                    <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                ...
                                de
                                <span class="font-medium"><> </>{productos.length}<> </></span>
                                productos
                            </p>
                        </div>
                        <div>
                            <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                                <button onClick={prevPage} disabled={currentPage === 1} class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                                ...
                                {getPageNumbers().map((item, index) => (
                                    <button
                                        ...
                                        className={currentPage === item ? 'relative z-10 inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' :
